...
Again we finished our last session in the Explore phase of our LA Cycle. Using GGplot and its layers to create data visualizations. Looking at variables that might be good predictors of at risk or early warning signs.
---
...
What are some things you are normally asked to communicate?
...
???
Learning analytics offers tremendous benefits, but we must navigate ethical challenges to ensure responsible and fair implementation. Let's explore key ethical considerations and the initiatives taken to address them.
...
.code60.remark-code[
```{r corr1, echo=TRUE, fig.show='hide', message=FALSE, warning=FALSE}
...
.panel[.panel-name[ANSWER]
.code60.remark-code[.pull-left[
```{r viz2, echo=TRUE, fig.show='hide', message=FALSE, warning=FALSE}
data_to_explore %>%
...
.pull-right[
```{r, ref.label="viz2", echo=FALSE, message=FALSE, warning=FALSE,  out.width = '350px'}
data_to_explore %>%
  ggplot(aes(x = time_spent_hours, 
             y = proportion_earned, 
             color = enrollment_status)) +
...
<img src="img/communicate_wflow.png" height="300px"/>
]
.panel[.panel-name[Flow]
...
---
# FLEXDASHBOARD Product
.panelset[
.panel[.panel-name[Flexdashboard]
...
.panel[.panel-name[dashboard template]

<img src="img/flexdashboard.jpg" height="300px"/>
...
[Flexdashboard: Easy interactive dashboards for R](https://posit.co/blog/flexdashboard-easy-interactive-dashboards-for-r/)
...
- Complete the badge requirement document: [foundationlab4_badge- Data Visualization](https://laser-institute.github.io/LASER_Foundations_2023/lab4/found-lab-4-badge.html).
