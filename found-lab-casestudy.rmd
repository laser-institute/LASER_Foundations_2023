...
-   save variable to `student_id` variable so you can join with the same
    class.
...
NOW: - full join - joined_data - survey - save as a new object called
`data_to_explore` - inspect the data object
