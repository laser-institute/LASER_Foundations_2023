...
Now, we will work on third data source to clean out data using the [janitor](https://garthtarr.github.io/meatR/janitor.html package which has
...
# add predictor variable for science interest
...
findings about.  Feel free to use the template in the lab 4 folder.
