...
will seperate course_id variable again.
...
As you can see in the gradebook our grade is in points. We want it in a proportion
- Create a new variable call it: `proportion_earned`
- take 'total points earned' divide by 'total points possible and multiple by 100
- save it as a new object `gradebook1`
