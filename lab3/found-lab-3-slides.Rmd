...
.center[
<img src="img/animation_comparison.gif" height="400px"/>
]
...
Heatmaps: Visualize patterns and relationships in large datasets.
Network diagrams: Illustrate connections and relationships between entities.
Treemaps: Represent hierarchical data structures in a space-efficient manner.
...
.column-left[- Data Visualization
- Data Transformation
